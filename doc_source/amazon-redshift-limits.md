...
+ The number of concurrent user connections that can be made to a cluster is 500\. For more information, see [Connecting to an Amazon Redshift Cluster Using SQL Client Tools](connecting-to-cluster.md) in the *Amazon Redshift Cluster Management Guide*\.
