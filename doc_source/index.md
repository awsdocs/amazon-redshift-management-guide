...
+ [Amazon Redshift Serverless](working-with-serverless.md)
   + [What is Amazon Redshift Serverless?](serverless-whatis.md)
      + [Overview of Amazon Redshift Serverless features](serverless-considerations.md)
      + [Comparing Amazon Redshift Serverless to a provisioned cluster](serverless-console-comparison.md)
   ...
   + [Get started with Amazon Redshift Serverless](serverless-get-started.md)
      + [Get started with Amazon Redshift Serverless using the console](serverless-console-workflows.md)
         + [Setting up Amazon Redshift Serverless for the first time](serverless-console-getting-started.md)
         + [Configuring Amazon Redshift Serverless](serverless-console-configuration.md)
         + [Checking Amazon Redshift Serverless using the dashboard](serverless-dashboard.md)
         + [Searching for a workgroup](serverless-console-workgroups.md)
         + [Configuring a workgroup](serverless-workgroup-describe.md)
         + [Searching for a namespace](serverless-console-configure-namespace.md)
         + [Configuring a namespace](serverless-console-namespace-config.md)
   ...
   + [CloudTrail for Amazon Redshift Serverless](serverless-cloudtrail.md)
      + [Logging Amazon Redshift Serverless calls with AWS CloudTrail](serverless-logging-using-cloudtrail.md)
...
+ [Amazon Redshift clusters](working-with-clusters.md)
   ...
   + [Working with AQUA (Advanced Query Accelerator)](managing-cluster-aqua.md)
      + [When does Amazon Redshift use AQUA to run queries?](managing-cluster-aqua-understanding.md)
